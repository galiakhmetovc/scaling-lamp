...
- складывать долговременные результаты в явные места: `docs/`, `artifacts/`, `diagnostics/`, Logseq graph, project-specific subdirectory или другой согласованный каталог;
