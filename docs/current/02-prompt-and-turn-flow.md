...
- `knowledge_search`/`knowledge_read` — canonical repo/runtime knowledge index, не SilverBullet/Mem0/KV.
...
- нужно найти документацию runtime/repo, справочник tools или operator docs — `knowledge_search`/`knowledge_read`;
