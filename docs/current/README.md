...
- **Container add-ons** — внешняя обвязка вокруг host `agentd`: Docker, SearXNG, Logseq Publish, SilverBullet, Jaeger, Caddy и legacy Obsidian; см. [14-container-addons.md](14-container-addons.md).
