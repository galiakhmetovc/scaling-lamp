...
assert_contains "$containers_jaeger_dry_run_output" "upsert disabled OTLP trace export defaults in /etc/teamd/teamd.env"
assert_contains "$containers_jaeger_dry_run_output" "TEAMD_OTLP_EXPORT_ENABLED=false"
