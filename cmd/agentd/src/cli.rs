...
const REPL_HELP: &str = "commands: \\помощь|/help | \\показать|/show | \\план|/plan | \\задачи|/jobs | \\скиллы|/skills | \\включить <skill>|/enable <skill> | \\выключить <skill>|/disable <skill> | /approve [approval-id] | \\выход|/exit";
