...
pub fn render_help_message() -> String {
    [
        ...
        "/tasks - show delegated tasks for current session",
        "/task <task_id> - show delegated task details",
        "/follow <task_id> - send task result to this chat when it finishes",
        "/unfollow <task_id> - stop sending that task result to this chat",
        ...
        "/cancel <task_id> - cancel a delegated task",
        "/model <model|default> - set or reset the session model",
        "/think <off|low|medium|high|default> - set or reset think level",
        "/reasoning <on|off> - toggle reasoning visibility",
        "/autoapprove <on|off> - toggle auto-approve",
        "/compact - compact current session context",
        "/skills - list session skills",
        "/enable <skill_name> - enable a session skill",
        "/disable <skill_name> - disable a session skill",
        "/files - list files in the current session",
        "/file <artifact_id> - send a session file back to Telegram",
        "/target - register current chat as delivery target",
        "/targets - list registered delivery targets",
        "/outputs [attach <target_id> summary|detach <target_id>] - control current session output routes",
        "/routes - show current session output routes",
