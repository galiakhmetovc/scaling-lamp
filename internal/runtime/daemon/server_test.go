...
func TestWebsocketSettingsFormApplyReloadsAgentAndRejectsStaleRevision(t *testing.T) {
	...
	assertSettingValue(t, applied["quick_controls"], "model", "glm-5-turbo")
	assertSettingValue(t, applied["quick_controls"], "reasoning_effort", "medium")
	assertSettingValue(t, applied["quick_controls"], "approval_mode", "always_allow")
	assertSettingValue(t, applied["quick_controls"], "allow_network", true)
